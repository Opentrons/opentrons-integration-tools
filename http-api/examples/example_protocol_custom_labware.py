def get_values(*names):
    import json
    _all_values = json.loads("""{"p300_mount":"right","tip_type":"opentrons_96_tiprack_300ul","plate_type":"biorad_96_wellplate_200ul_pcr"}""")
...
def run(ctx):
    ...
    reservoir = ctx.load_labware('nicoman_16_wellplate_5ul', 8)
